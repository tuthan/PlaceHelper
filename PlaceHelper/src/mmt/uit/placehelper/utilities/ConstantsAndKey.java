...
public class ConstantsAndKey {
    ...
    public static final String KEY_ATTRACTION = "cinema";
    public static final String KEY_GAS = "gas";
    public static final String KEY_PLACE = "coffee";
	...
	public static final int CHANGE_LOC = 1;
	public static final int RESTORE_LOC = 121;
	public static final int CHECK_SETTING = 1;
	public static final int WAIT_MSG = 2;
	public static final int LOC_NOTFOUND= 3;
	public static final int ABOUT= 10;
	public static final int ADD_CAT= 201;
